...
public class TestePost {
	...
	@Test
	public void testCurtirDescurtir() {
		try {
			...
			Assert.assertTrue(mario.getNotificacao() == 3);
			...
			Assert.assertTrue(mario.getNotificacao() == 0);
			
			jane.descurtir(mario, 0);

			Assert.assertTrue(mario.getPop() == 20);
			Assert.assertTrue(mario.getNotificacao() == 1);
